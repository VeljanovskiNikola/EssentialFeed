...
//
//  Created by Nikola Veljanovski on 18.6.25.
//
...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_feedImageView_cancelsImageLoadingWhenWhenNotVisibleAnymore() {
        let image0 = makeImage(url: URL(string: "http://url-0.com")!)
        let image1 = makeImage(url: URL(string: "http://url-1.com")!)
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageView_rendersImageLoadedFromURL() {
        ...
        XCTAssertEqual(view0?.renderedImage, imageData0, "Expected no image for first view once second image loading completes successfully")
    ...
    func test_feedImageViewRetryAction_retriesImageLoad() {
        ...
        let view0 = sut.simulateFeedImageViewVisible(at: 0)
        let view1 = sut.simulateFeedImageViewVisible(at: 1)
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url], "Expected two image URL requests for the the two visible views")
        ...
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url, image0.url], "Expected third imageURL request after first view rety action")
        
        view1?.simulateRetryAction()
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url, image0.url, image1.url], "Expected fourth imageURL request after second view rety action")
    }
